...
def publishBojong(nama, berat, jenis_paket, jenisPaketWaktu):
    ...
    +jenisPaketWaktu +'|'+berat+'|'+Pengembalian_Cucian+'|'+str_harga+'', qos=1, retain=False)
...
def publishSoang(nama, berat, jenis_paket, jenisPaketWaktu):
    ...
    +'|'+berat+'|'+Pengembalian_CucianSoang+'|'+str_hargaSoang+'', qos=1, retain=False)
...
def perbandingan(nama, berat, jenis_paket, jenisPaketWaktu):
    ...
    +'|'+berat+'|'+Pengembalian_Cucian+'|'+str_harga+'', qos=1, retain=False)
...
def menuLaundry():
    ...
    while status:
        ...
        if Jenis_paket == 'Simpel' or Jenis_paket == 'Dry' or Jenis_paket == 'Komplit':
            l = [nama, berat, Jenis_paket, jenisPaketWaktu]
        elif Jenis_paket == 'Simpel':
            if jenisPaketWaktu == 'Reguler':
